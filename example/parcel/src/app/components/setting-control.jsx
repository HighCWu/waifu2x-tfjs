            ...
            <div style={style.card} className="mdl-card mdl-shadow--2dp">
                <div className="mdl-card--expand">
                    ...
                    <div style={style.cardComponent}>
                        ...
                        <RadioInput id="option-1" label="Artwork" value="Artwork" onChange={this.props.onImageTypeChange} checked={this.props.imageType} />
                        <RadioInput id="option-2" label="Artwork_y" value="Artwork_y" onChange={this.props.onImageTypeChange} checked={this.props.imageType} />
                        <RadioInput id="option-3" label="Photo" value="Photo" onChange={this.props.onImageTypeChange} checked={this.props.imageType} />
                    </div>

                    <div style={style.cardComponent}>
                        <CardComponentName name="GPU available memory" />
                        <CardComponentDescription description={`${this.props.memory} MB`} />
                        {
                            <Slider id="slider-0" min="0" max="4096" step="512" value={this.props.memory} onChange={this.props.onMemoryChange} />
                        }
                    </div>
                    ...
                    <div style={style.cardComponent}>
                        ...
                        <CardComponentDescription description={this.props.denoisingLevelDescription} />
                        {
                            this.props.scaleNumber == 0 ?
                                <Slider id="slider-2" min="1" max="3" step="1" value={this.props.denoisingLevelNumber} onChange={this.props.onDenoisingLevelChange} /> :
                                <Slider id="slider-2" min="0" max="3" step="1" value={this.props.denoisingLevelNumber} onChange={this.props.onDenoisingLevelChange} />
                        }
                    </div>
                </div>
